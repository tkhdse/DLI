...
class EmbeddingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEmbeddingBatch = channel.unary_unary(
                '/embedding.EmbeddingService/GetEmbeddingBatch',
...
def add_EmbeddingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetEmbeddingBatch': grpc.unary_unary_rpc_method_handler(
                    servicer.GetEmbeddingBatch,
